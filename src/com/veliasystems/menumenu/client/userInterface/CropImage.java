...
public class CropImage extends MyPage implements IObserver{
	...
	private void cropImage(ImageBlob imageInsert) {
		...
		boundaryPanel.setStyleName("boundaryPanel", true);
...
//					centerMovePanel.setHeight(displayCenterPanelHeight + "px");
				...
				centerMovePanel.setHeight(displayCenterPanelHeight-2 + "px"); //-2 because of borders
...
//			public void onClick(ClickEvent event) {
//				PagesController.showWaitPanel();
//				JQMContext.changePage(RestaurantController.restMapView.get(Long
//						.parseLong(imageBlob.getRestaurantId())),
//						Transition.SLIDE);
//			}
//		});
//
...
//		topPanel.getElement().setId("moveTopPanel");
////		topHand.setStyleName("topHand cropArrow", true);
//		topHand.setStyleName("topHand cropPanel", true);
//		topHand.getElement().setId("moveTopHand");
//
//		rightPanel.getElement().setId("moveRightPanel");
//		rightPanel.setStyleName("rightPanel", true);
...
//				.setProperty("maxWidth", PagesController.contentWidth + "px");
//
//		dragController = new PickupDragController(boundaryPanel, true);
//		dropController = new AbsolutePositionDropController(boundaryPanel);
//		
//		FlowPanel ddd = new FlowPanel();
//		ddd.getElement().setId("TESTING");
//		
//		topHand.wrap(ddd.getElement());
//		FlowPanel kkk = new FlowPanel();
//		new HTML(kkk.getElement().getString());
//		
//		boundaryPanel.add(topPanel);
//		boundaryPanel.add(topHand);
//		boundaryPanel.add(rightPanel);
...
//				Object eventSource = event.getSource();
//
//				if (!(eventSource instanceof HTML))
//					return;// dziwne???
//
//				HTML element = (HTML) eventSource;
//
//				if (element.getElement().getId()
//						.equals(centerMovePanel.getElement().getId())) {
//					interval = myOnMoveCenter(
//							element.getElement().getId(),
//							getOffsetWidth(centerMovePanel.getElement().getId()),
//							getOffsetHeight(centerMovePanel.getElement()
//									.getId()));
//					return;
//				}
//
//				switch (imageBlob.getImageType()) {
//				case LOGO:
//					interval = myOnMoveLogo(element.getElement().getId(),
//							minLogoRatio, maxLogoRatio);
//					break;
//				case PROFILE:
//					interval = myOnMoveProfile(element.getElement().getId(),
//							ratioProfile);
//					break;
//
//				case MENU:
...
//	}
//
//	private native int myOnMoveLogo(String elementId, double minRatio,
//			double maxRatio)/*-{
//		var element = $wnd.document.getElementById(elementId);
//
...
//									newCenterMovePanelWidth = newCenterMovePanelHeight * minRatio;
//								}
//								if (newCenterMovePanelWidth <= 1
//										|| newCenterMovePanelHeight <= 1
//										|| parseInt(newCenterMovePanelWidth)
//												+ parseInt(moveLeftPanelWidth) >= width
//										|| parseInt(newCenterMovePanelHeight)
//												+ parseInt(moveBottomPanelHeight) >= height) {
//									return;
//								}
//								$wnd.document.getElementById("centerMovePanel").style.height = newCenterMovePanelHeight + "px";
//								$wnd.document.getElementById("centerMovePanel").style.top = parseInt(centerMovePanelCurrentPosition) + parseInt(deltaPosition) + "px";
...
//			moveTopPanelHeight = moveTopPanelHeight.substring(0, moveTopPanelHeight.length - 2); //wyrzucamy koncowke 'px'
//
//			interval = $wnd.setInterval(
//							function() {
//								var currentPosition = element.parentNode.style.left;
//								currentPosition = currentPosition.substring(0,
//										currentPosition.length - 2);
//								var moveCenterPaneWidth = $wnd.document
//										.getElementById("centerMovePanel").style.width;
//								moveCenterPaneWidth = moveCenterPaneWidth
//										.substring(0,
//												moveCenterPaneWidth.length - 2); //wyrzucamy koncowke 'px'
//
//								var deltaPosition = parseInt(currentPosition)
//										- parseInt(position); //delta y
//
//								var newCenterMovePanelWidth = parseInt(moveCenterPaneWidth)
//										+ parseInt(deltaPosition);
//								//				var newMoveRightPanelWidth = width - newCenterMovePanelWidth - moveLeftPanelWidth;
//
//								var newCenterMovePanelHeight = $wnd.document
//										.getElementById("centerMovePanel").style.height;
//								newCenterMovePanelHeight = newCenterMovePanelHeight
//										.substring(
//												0,
//												newCenterMovePanelHeight.length - 2); //wyrzucamy koncowke 'px'
//
//								if (newCenterMovePanelWidth
//										/ newCenterMovePanelHeight > maxRatio) {
//									newCenterMovePanelHeight = newCenterMovePanelWidth
//											/ maxRatio;
//								} else if (newCenterMovePanelWidth
//										/ newCenterMovePanelHeight < minRatio) {
//									newCenterMovePanelHeight = newCenterMovePanelWidth
//											/ minRatio;
//								}
//
...
//												+ parseInt(moveLeftPanelWidth) >= width
//										|| parseInt(newCenterMovePanelHeight)
//												+ parseInt(moveTopPanelHeight) >= height) {
//									return;
//								}
//								$wnd.document.getElementById("centerMovePanel").style.width = newCenterMovePanelWidth
//										+ "px";
//								$wnd.document.getElementById("centerMovePanel").style.height = newCenterMovePanelHeight
//										+ "px";
//								//$wnd.document.getElementById("moveRightPanel").style.width = newMoveRightPanelWidth +"px";
//
//								position = element.parentNode.style.left; //y
//								position = position.substring(0,
//										position.length - 2); //wyrzucamy koncowke 'px'
//							}, 125);
//		} else if (elementId.indexOf("Bottom") >= 0) {
//			$wnd.document.getElementById("moveTopHand").className = $wnd.document
//					.getElementById("moveTopHand").className
//					+ " moveElementHidden";
//			$wnd.document.getElementById("moveRightHand").className = $wnd.document
//					.getElementById("moveRightHand").className
//					+ " moveElementHidden";
//			$wnd.document.getElementById("moveBottomHand").className = $wnd.document
//					.getElementById("moveBottomHand").className
//					+ " moveElementHidden";
//			$wnd.document.getElementById("moveLeftHand").className = $wnd.document
//					.getElementById("moveLeftHand").className
//					+ " moveElementHidden";
//			$wnd.document.getElementById("moveBottomPanel").className = "bottomPanel moveChecked";
//			$wnd.document.getElementById("moveRightPanel").className = "rightPanel moveChecked";
//			var position;
...
//			}, 250);
//
//			var moveTopPanelHeight = $wnd.document
//					.getElementById("moveTopPanel").style.height;
//			moveTopPanelHeight = moveTopPanelHeight.substring(0,
//					moveTopPanelHeight.length - 2); //wyrzucamy koncowke 'px'
//			var moveLeftPanelWidth = $wnd.document
//					.getElementById("moveLeftPanel").style.width;
//			moveLeftPanelWidth = moveLeftPanelWidth.substring(0,
//					moveLeftPanelWidth.length - 2);
//
//			interval = $wnd
//					.setInterval(
//							function() {
//								var currentPosition = element.parentNode.style.top; //y
//								currentPosition = currentPosition.substring(0,
//										currentPosition.length - 2); //wyrzucamy koncowke 'px'
//								var deltaPosition = currentPosition - position; //delta y
//
//								var moveCenterPaneHeight = $wnd.document
//										.getElementById("centerMovePanel").style.height;
//								moveCenterPaneHeight = moveCenterPaneHeight
//										.substring(0,
//												moveCenterPaneHeight.length - 2); //wyrzucamy koncowke 'px'
//								var moveCenterPaneWidth = $wnd.document
//										.getElementById("centerMovePanel").style.width;
//								moveCenterPaneWidth = moveCenterPaneWidth
//										.substring(0,
//												moveCenterPaneWidth.length - 2); //wyrzucamy koncowke 'px'	
//
//								var newCenterMovePanelHeight = parseInt(moveCenterPaneHeight)
//										+ parseInt(deltaPosition);
//								var newCenterMovePanelWidth = moveCenterPaneWidth;
//
//								if (moveCenterPaneWidth
//										/ newCenterMovePanelHeight > maxRatio) {
//									newCenterMovePanelWidth = newCenterMovePanelHeight
//											* maxRatio;
//								} else if (moveCenterPaneWidth
//										/ newCenterMovePanelHeight < minRatio) {
//									newCenterMovePanelWidth = newCenterMovePanelHeight
//											* minRatio;
//								}
...
//			$wnd.document.getElementById("moveBottomPanel").className = "bottomPanel moveChecked";
//
//			var moveRightPanelWidth = $wnd.document
//					.getElementById("moveRightPanel").style.width;
//			moveRightPanelWidth = moveRightPanelWidth.substring(0,
//					moveRightPanelWidth.length - 2);
//			var moveTopPanelHeight = $wnd.document
//					.getElementById("moveTopPanel").style.height;
//			moveTopPanelHeight = moveTopPanelHeight.substring(0,
//					moveTopPanelHeight.length - 2); //wyrzucamy koncowke 'px'
...
//								currentPosition = currentPosition.substring(0,
//										currentPosition.length - 2);
//								var deltaPosition = parseInt(position)
//										- parseInt(currentPosition); //delta y
//
//								var centerMovePanelWidth = $wnd.document
//										.getElementById("centerMovePanel").style.width;
//								centerMovePanelWidth = centerMovePanelWidth
//										.substring(0,
//												centerMovePanelWidth.length - 2); //wyrzucamy koncowke 'px'
//								var newCenterMovePanelHeight = $wnd.document
//										.getElementById("centerMovePanel").style.height;
//								newCenterMovePanelHeight = newCenterMovePanelHeight
//										.substring(
...
//												newCenterMovePanelHeight.length - 2); //wyrzucamy koncowke 'px'
//
//								var newCenterMovePanelWidth = parseInt(centerMovePanelWidth)
//										+ parseInt(deltaPosition);
//								var newCenterMovePanelLeft = width
//										- parseInt(newCenterMovePanelWidth)
//										- parseInt(moveRightPanelWidth);
//
//								if (newCenterMovePanelWidth
//										/ newCenterMovePanelHeight > maxRatio) {
//									newCenterMovePanelHeight = newCenterMovePanelWidth
...
//										|| newCenterMovePanelHeight <= 1
//										|| parseInt(newCenterMovePanelWidth)
//												+ parseInt(moveRightPanelWidth) >= width
//										|| parseInt(newCenterMovePanelHeight)
//												+ parseInt(moveTopPanelHeight) >= height) {
//									return;
//								}
...
//								$wnd.document.getElementById("centerMovePanel").style.height = newCenterMovePanelHeight
//										+ "px";
//								$wnd.document.getElementById("centerMovePanel").style.left = newCenterMovePanelLeft
//										+ "px";
//
//								position = element.parentNode.style.left; //y
//								position = position.substring(0,
...
//			}, 250);
//
//			var bottomPanelHeight = $wnd.document
//					.getElementById("moveBottomPanel").style.height;
//			bottomPanelHeight = bottomPanelHeight.substring(0,
//					bottomPanelHeight.length - 2);
//			var moveLeftPanelWidth = $wnd.document
//					.getElementById("moveLeftPanel").style.width;
//			moveLeftPanelWidth = moveLeftPanelWidth.substring(0,
//					moveLeftPanelWidth.length - 2);
...
//								moveCenterPaneHeight = moveCenterPaneHeight
//										.substring(0,
//												moveCenterPaneHeight.length - 2);
//								var centerMovePanelCurrentPosition = $wnd.document
//										.getElementById("centerMovePanel").style.top;
//								centerMovePanelCurrentPosition = centerMovePanelCurrentPosition
//										.substring(
//												0,
//												centerMovePanelCurrentPosition.length - 2); //wyrzucamy koncowke 'px'
//
//								var newCenterMovePanelHeight = moveCenterPaneHeight
//										- deltaPosition;
//								var newCenterMovePanelWidth = newCenterMovePanelHeight
//										* ratio;
//
//								if (newCenterMovePanelHeight <= 0) {
//									return;
//								}
//								if (parseInt(newCenterMovePanelWidth)
//										+ parseInt(moveLeftPanelWidth) >= width) {
//									return;
//								}
//								var newMoveCenterPanelTop = height
//										- bottomPanelHeight
//										- newCenterMovePanelHeight;
//
//								if (newMoveCenterPanelTop <= 0) {
//									return;
//								}
//								$wnd.document.getElementById("centerMovePanel").style.height = newCenterMovePanelHeight
//										+ "px";
//								$wnd.document.getElementById("centerMovePanel").style.top = newMoveCenterPanelTop
//										+ "px";
//								$wnd.document.getElementById("centerMovePanel").style.width = newCenterMovePanelWidth
//										+ "px";
//
...
//					.getElementById("moveRightPanel").style.width;
//			moveRightPanelWidth = moveRightPanelWidth.substring(0,
//					moveRightPanelWidth.length - 2); //wyrzucamy koncowke 'px'
//			var position;
//
//			$wnd.setTimeout(function() { //czekamy aż drag stworzy swoje div'y
//				position = element.parentNode.style.top; //y
...
//												moveCenterPaneHeight.length - 2); //wyrzucamy koncowke 'px'
//
//								var centerMovePanelLeft = $wnd.document
//										.getElementById("centerMovePanel").style.left;
//								centerMovePanelLeft = centerMovePanelLeft
//										.substring(0,
//												centerMovePanelLeft.length - 2); //wyrzucamy koncowke 'px'
//
//								var newCenterMovePanelHeight = moveCenterPaneHeight
//										- deltaPosition;
//								var newCenterMovePanelWidth = newCenterMovePanelHeight
...
//									return;
//								}
//								if (parseInt(newCenterMovePanelHeight)
//										+ parseInt(moveTopPanelHeight) >= height) {
//									return;
//								}
//
//								var newMoveCenterPanelLeft = width
//										- moveRightPanelWidth
//										- newCenterMovePanelWidth;
//
//								if (newMoveCenterPanelLeft <= 0) {
//									return;
//								}
...
//								if (deltaPosition != 0) { //zwiekszamy
//									$wnd.document
//											.getElementById("centerMovePanel").style.height = newCenterMovePanelHeight
//											+ "px";
//									$wnd.document
//											.getElementById("centerMovePanel").style.width = newCenterMovePanelWidth
//											+ "px";
//									$wnd.document
//											.getElementById("centerMovePanel").style.left = newMoveCenterPanelLeft
//											+ "px";
//								}
//								position = element.parentNode.style.top; //y
//								position = position.substring(0,
...
//
//			var bottomPanelHeight = $wnd.document
//					.getElementById("moveBottomPanel").offsetHeight;
//			$wnd.document.getElementById("moveTopPanel").className = "topPanel moveChecked";
//			interval = $wnd
//					.setInterval(
//							function() {
...
//								}
//
//								var newCenterMovePanelTop = height
//										- bottomPanelHeight
//										- newCenterMovePanelHeight;
//								if (newCenterMovePanelTop < 0) {
//									return;
...
//								$wnd.document.getElementById("centerMovePanel").style.height = newCenterMovePanelHeight
//										+ "px";
//								$wnd.document.getElementById("centerMovePanel").style.top = newCenterMovePanelTop
//										+ "px";
//
//								position = element.parentNode.style.top; //y
//								position = position.substring(0,
...
//
//			var moveTopPanelHeight = $wnd.document
//					.getElementById("moveTopPanel").offsetHeight;
//
//			interval = $wnd
//					.setInterval(
//							function() {
...
//										- deltaPosition;
//
//								if (moveTopPanelHeight
//										+ newCenterMovePanelHeight > height) {
//									newCenterMovePanelHeight = height
//											- moveTopPanelHeight;
//								}
//								$wnd.document.getElementById("centerMovePanel").style.height = newCenterMovePanelHeight
...
//										- parseInt(moveRightPanelWidth)) {
//									$wnd.document
//											.getElementById("centerMovePanel").style.width = "1px";
//									return;
//								} else if (parseInt(currentPosition) <= 0) {
//									$wnd.document
//											.getElementById("centerMovePanel").style.width = parseInt(width)
//											- parseInt(moveRightPanelWidth)
//											+ " px";
//									return;
//								}
//								$wnd.document.getElementById("centerMovePanel").style.width = width
//										- currentPosition
//										- moveRightPanelWidth
//										+ "px";
//								$wnd.document.getElementById("centerMovePanel").style.left = currentPosition
//										+ "px";
//
//							}, 125);
//		}
...
//	}-*/;
//
//	private native int myOnMoveCenter(String elementId, int moveElementWidth,
//			int moveElementHeight)/*-{
//		var element = $wnd.document.getElementById(elementId);
//		if (element === "undefined")
//			return -1;
//
...
//							var currentPositionLeft = element.parentNode.style.left;
//
//							var topPanelHeight = currentPositionTop.substring(
//									0, currentPositionTop.length - 2); //wyrzucamy koncowke 'px';
//							var deltaTopPanelHeight = $wnd.document
//									.getElementById("moveTopPanel").offsetHeight
//									- topPanelHeight;
//							var bottomPanelHeight = height - moveElementHeight
//									- topPanelHeight //$wnd.document.getElementById("moveTopPanel").offsetHeight + deltaTopPanelHeight;
//
//							var leftPanelWidth = currentPositionLeft.substring(
//									0, currentPositionLeft.length - 2); //wyrzucamy koncowke 'px';;
//							var deltaLeftPanelWidth = $wnd.document
//									.getElementById("moveLeftPanel").offsetWidth
//									- leftPanelWidth;
//							var rightPanelWidth = width - moveElementWidth
//									- leftPanelWidth //$wnd.document.getElementById("moveLeftPanel").offsetWidth + deltaLeftPanelWidth;
//
//							//currentPosition=currentPosition.substring(0, currentPosition1.length-2);
//							$wnd.document.getElementById("moveTopPanel").style.height = currentPositionTop;
//							$wnd.document.getElementById("moveBottomPanel").style.height = bottomPanelHeight
//									+ "px";
//							$wnd.document.getElementById("moveLeftPanel").style.width = currentPositionLeft;
//							$wnd.document.getElementById("moveRightPanel").style.width = rightPanelWidth
//									+ "px";
//						}, 100);
//
//		return interval;
...
//			centerPanelTop = centerPanelTop.substring(0, centerPanelTop.length - 2); //usuwa koncowke '-px'
//		var centerPanelLeft = centerPanel.style.left;
//			centerPanelLeft = centerPanelLeft.substring(0,
//				centerPanelLeft.length - 2); //usuwa koncowke '-px'
//
//		//$wnd.console.log(centerPanel.style.top);
//
//		//USTAWIANIE STRZALEK
...
//			$wnd.document.getElementById("moveTopHand").className = "topHand cropArrow rotation90left";
//			$wnd.document.getElementById("moveBottomHand").className = "bottomHand cropArrow rotation90left";
//			$wnd.document.getElementById("moveTopHand").style.top = -15 + parseInt(centerPanelTop) + "px";
//			$wnd.document.getElementById("moveTopHand").style.left = -45 + parseInt(centerPanelLeft) + parseInt(centerPanelWidth) + "px";
//			$wnd.document.getElementById("moveBottomHand").style.top = -45 + parseInt(centerPanelTop) + parseInt(centerPanelHeigth) + "px";
//			$wnd.document.getElementById("moveBottomHand").style.left = -15	+ parseInt(centerPanelLeft) + "px";
//		} else {
//
//			$wnd.document.getElementById("moveTopHand").style.top = -15 + parseInt(centerPanelTop) + "px";
//			$wnd.document.getElementById("moveTopHand").style.left = -30 + parseInt(centerPanelLeft) + parseInt(centerPanelWidth) / 2 + "px";
//			$wnd.document.getElementById("moveRightHand").style.left = -45 + parseInt(centerPanelLeft) + parseInt(centerPanelWidth) + "px";
//			$wnd.document.getElementById("moveRightHand").style.top = -30 + parseInt(centerPanelTop) + parseInt(centerPanelHeigth) / 2 + "px";
//			$wnd.document.getElementById("moveBottomHand").style.top = -45 + parseInt(centerPanelTop) + parseInt(centerPanelHeigth) + "px";
//			$wnd.document.getElementById("moveBottomHand").style.left = -30 + parseInt(centerPanelLeft) + parseInt(centerPanelWidth) / 2 + "px";
//			$wnd.document.getElementById("moveLeftHand").style.left = -15 + parseInt(centerPanelLeft) + "px";
//			$wnd.document.getElementById("moveLeftHand").style.top = -30 + parseInt(centerPanelTop) + parseInt(centerPanelHeigth) / 2 + "px";
//		}
//
//		// KONIEC - USTAWIANIE STRZALEK
//		//$wnd.document.getElementById();
...
//		//USTAWIANIE PRZYCIEMNIANYCH PANELI
//		$wnd.document.getElementById("moveTopPanel").style.height = centerPanelTop + "px";
//		//-2 grubosc ramki (gorna i dolna)
//		$wnd.document.getElementById("moveBottomPanel").style.height = -2 + parseInt(height) - parseInt(centerPanelTop) - parseInt(centerPanelHeigth) + "px";
//		$wnd.document.getElementById("moveLeftPanel").style.width = centerPanelLeft + "px";
//		//-2 grubosc ramki (gorna i dolna)
//		$wnd.document.getElementById("moveRightPanel").style.width = -2 + parseInt(width) - parseInt(centerPanelLeft) - parseInt(centerPanelWidth) + "px";
//		// KONIEC - USTAWIANIE PRZYCIEMNIANYCH PANELI
//
//	}-*/;
//
